...
const tutorialOutline: OutlineSection[] = [
  ...
  { id: "operators", label: "8. Operators" },
  {
    id: "control-flow",
...
const TableOfContents = () => {
  ...
  return (
    <nav aria-label="Tutorial contents" className="hidden lg:block">
      <div className="sticky top-28 rounded border border-charcoal-800 bg-charcoal-950/80 p-4">
        <p className="text-xs font-semibold uppercase tracking-widest text-gold-400 mb-4">On this page</p>
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="lg:grid lg:grid-cols-[18rem,1fr] lg:gap-10">
          ...
          <div>
            ...
            <Section id="operators" number="8." title="Operators">
              <p>
                The main operator set covers arithmetic, comparisons, boolean logic, and explicit casts.
              </p>
              <ul className="list-disc list-inside space-y-1 text-charcoal-300">
                ...
                <li>Equality helper: <code className="text-gold-300">matches</code> (alias for <code className="text-gold-300">==</code>)</li>
              ...
              />
              <p>
                Compound assignments like <code className="text-gold-300">+=</code> or <code className="text-gold-300">-=</code> update existing mutable
                bindings.
              </p>
            </Section>
        ...
        <nav className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-12">
          {[
            ...
            { href: "#variables", label: "2. Variables & Mutability" },
            { href: "#constants", label: "3. Constants" },
            { href: "#primitives", label: "4. Primitive Types" },
            { href: "#numeric-literals", label: "5. Numeric Literals" },
            { href: "#casting", label: "6. Casting Rules" },
            { href: "#comments", label: "7. Comments" },
            { href: "#operators", label: "8. Operators" },
            { href: "#control-flow", label: "9. Control Flow" },
            { href: "#arrays", label: "10. Arrays" },
            { href: "#functions", label: "11. Functions" },
            { href: "#structs", label: "12. Structs" },
            { href: "#methods", label: "13. Methods with impl" },
            { href: "#pattern-matching", label: "14. Pattern Matching" },
            { href: "#error-handling", label: "15. Error Handling" },
            { href: "#modules", label: "16. Modules" },
            { href: "#builtins", label: "17. Built-in Utilities" },
            { href: "#best-practices", label: "18. Best Practices" },
            { href: "#putting-it-together", label: "19. Putting It Together" },
          ].map((item) => (
            <a
              key={item.href}
              href={item.href}
              className="rounded border border-charcoal-700 bg-charcoal-900/60 px-4 py-3 text-sm font-medium text-charcoal-200 hover:border-gold-500/60 hover:text-gold-300 transition"
            >
              {item.label}
            </a>
          ))}
